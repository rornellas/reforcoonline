...
<html>
  <head>
    ...
    <title>Reforço Online - Start Bootstrap Template</title>
  ...
  <body>
        ...
        <div class="carousel-inner">
          <div class="item active">
            ...
            <div class="carousel-caption">
              <h1>Reforço Online - A Bootstrap 3 Template</h1>
            </div>
          </div>
          <div class="item">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-4">
            ...
            <p>The 'Reforço Online' website template by <a href="http://startbootstrap.com">Start Bootstrap</a> is built with <a href="http://getbootstrap.com">Bootstrap 3</a>. Make sure you're up to date with latest Bootstrap documentation!</p>
          </div>
          <div class="col-lg-4 col-md-4">
    ...
    <div class="section-colored text-center">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h2>Reforço Online: A Clean &amp; Simple Full Website Template by Start Bootstrap</h2>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6">
            <h2>Reforço Online Features Include:</h2>
            <ul>
    ...
    <div class="container">
      ...
      <div class="row well">
        <div class="col-lg-8 col-md-8">
          <h4>'Reforço Online' is a ready-to-use, Bootstrap 3 updated, multi-purpose HTML theme!</h4>
